...
data1(1,:)=title;
    ...
    path_out='C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\';  
    path_strong='C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\图像增强后的图像\';
    path_gre='C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\绿色通道\';
    path_cake='C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\cake\';
    path_hat='C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\hat\';
...
for j = 1 : length(file)
   ...
   PIC_sim=cell(1,count);
    ...
    adressString=['C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\最佳阀值\' strcat(file(j).name)  sprintf('%0.1d', T) '.bmp']; 
   ...
   imwrite(show(pic_cake,1),strcat(path_cake,file(j).name));
   imwrite(show(pic_hat_z,1),strcat(path_hat,file(j).name));



end
 xlswrite('C:\Users\dell\Desktop\科研\基于散度和Cake滤波器的\针对多阀值的分割方法-drive\数据输出\data1.xls',data1);
toc
